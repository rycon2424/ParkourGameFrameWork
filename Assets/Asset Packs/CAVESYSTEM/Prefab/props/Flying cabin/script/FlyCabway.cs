		...
		for (int i=0; i <= Waypoint.Length; i++)
		{
			...
			if(i%2==0)
			{
				...
				if (i > 0)
				{
					...
					WaypointInternal[secArray] = Waypoint[i].transform.Find("TakeOff") as Transform;
					secArray += 1;
				}
	...
	void Update () {
		...
		if (distanceNextWaypoint <= distanceFromWaypoint )
		{
			...
			case "TAKEOFF": 
				...
				stopTime = 0;
				colliderWall1 = transform.Find ("colliderWall1");
				colliderWall2 = transform.Find ("colliderWall2");
				colliderWall3 = transform.Find ("colliderWall3");
				colliderWall4 = transform.Find ("colliderWall4");
				colliderWall5 = transform.Find ("colliderWall5");
